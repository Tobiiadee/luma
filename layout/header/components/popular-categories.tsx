...
export default function PopularCategories() {
  ...
  return (
    <motion.div
      ...
      className='absolute top-[150%] -left-12 md:left-0 w-[80vw] sm:w-[60vw] lg:w-[40vw] rounded-lg flex flex-col space-y-2 bg-foreground shadow-md px-4 pt-2 pb-4 z-50'>
...
function PopularCategoriesItem({
  image,
  name,
  noOfItems,
}: {
