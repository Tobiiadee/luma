...
export default function PopularCategories() {
  ...
  return (
    <motion.div
      ...
      className='absolute top-[110%] sm:top-[150%] left-0 sm:-left-14 lg:left-0 w-screen sm:w-[60vw] lg:w-[40vw] rounded-b-lg sm:rounded-lg flex flex-col space-y-2 bg-foreground shadow-md px-4 pt-2 pb-4 z-50'>
